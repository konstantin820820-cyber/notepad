...
class _EditorScreenState
  ...
  // FORMAT
  //
  // Здесь мы НЕ используем QuillSimpleToolbar.
  //
  // Все кнопки напрямую работают с QuillController.
  // ==========================================================
